...
function benribot_settings_page_html() {
    ...
    <div class="wrap">
        ...
        <p><?php esc_html_e( 'BenriBot is your AI agent for eCommerce. Add your Client Key below to integrate the chat widget into your WooCommerce store.', 'benribot-for-woocommerce' ); ?></p>
...
function benribot_client_key_field_html() {
    ...
    <p class="description">
        <?php esc_html_e( 'You can get your Client Key from your BenriBot dashboard.', 'benribot-for-woocommerce' ); ?>
    </p>
    <?php
}
